...
- `experiments/` — curated studies, numbered by narrative: `00_openloop` (data
  ...
  benchmark) → `03_region_split_pendulum`. Each study dir: `README.md` (scope
  only), `results.md` (findings, generated by `analysis.py`), `figures/`.
- `notebook/` — curated explanatory notebooks for SSN, PDAP configuration, and selected result views.
- `docs/research-directions.md` — provenance log for the research-direction summaries;
  `docs/research/` — theory program (`OVERVIEW.md`, `CLAIMS.md`, `NOTATION.md`);
  `docs/mlflow.md` — MLflow tracking-server guide; `docs/adr/` — decisions.
