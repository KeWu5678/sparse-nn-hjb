...
record_root="$repo_root/rawdata/logs/multirun/vdp/moment_penalty/followup"
jobs="${JOBS:-8}"
...
run_stage tanh_softplus_h1 tanh,softplus 1e-5 1e-10 2.01 '[1.0,1.0]' 0,0.1,10
run_stage gaussian_h1 gaussian 1e-5 1e-10 3 '[1.0,1.0]' 0,0.1,10
run_stage gelu_h1 gelu_squared 1e-3 1e-10 3 '[1.0,1.0]' 0,0.1,10
run_stage matern_h1 matern52 1e-5 1e-7 2.01 '[1.0,1.0]' 0,0.1,10

run_stage tanh_softplus_l2 tanh,softplus 1e-5 1e-10 2.01 '[1.0,0.0]' 0,0.1,1,10
run_stage gaussian_l2 gaussian 1e-5 1e-10 3 '[1.0,0.0]' 0,0.1,1,10
run_stage gelu_l2 gelu_squared 1e-3 1e-10 3 '[1.0,0.0]' 0,0.1,1,10
