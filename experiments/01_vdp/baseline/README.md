# Historical baseline — Van der Pol

These frontiers pool historical runs and stored training-coordinate errors. The old
VDP and pendulum analyzers were duplicate copies; the pendulum copy also defaulted
to the VDP dataset. They are not the current paper's baseline generator.
...
[`outdated/experiment-code-cleanup-2026-09-12/`](../../../outdated/experiment-code-cleanup-2026-09-12/experiments/01_vdp/baseline/).
