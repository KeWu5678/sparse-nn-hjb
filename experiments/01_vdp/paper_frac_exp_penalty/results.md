...
- **batch**: sparsest good fit is `k (power)=4.0`, α=0.001, γ=0 — 9 neurons at relative H¹ 0.1274 (score 1.147). Most accurate fit is `k (power)=5.0`, α=1e-06, γ=0 — relative H¹ 0.0970 at 29 neurons.
- **sequential**: sparsest good fit is `k (power)=3.0`, α=0.001, γ=0 — 10 neurons at relative H¹ 0.1274 (score 1.274). Most accurate fit is `k (power)=2.01`, α=1e-06, γ=0 — relative H¹ 0.0767 at 88 neurons.
...
*Running best relative H¹ validation error against neuron count, for the two insertion modes. Batch admits up to `N_ins = 15` atoms per outer iteration against one frozen residual; sequential admits the highest-ranked returned candidate and runs at `T_out = 150` for a matched neuron budget. All runs use seed 42.*
...
- **batch**: 37/40 runs terminated before `T_out = 10`; median 4 iterations, max 10.
- **sequential**: 40/40 runs terminated before `T_out = 150`; median 15 iterations, max 108.
...
| ----------- | ------------------- | ----------- | ---------------- |
| 10          | 0.1283              | 0.1274      | 0.1274           |
| 20          | 0.1003              | 0.1059      | 0.1045           |
| 40          | 0.0970              | 0.0970      | 0.0971           |
| 80          | 0.0970              | 0.0970      | 0.0971           |
| 120         | 0.0970              | 0.0970      | 0.0767           |
| 160         | 0.0970              | 0.0970      | 0.0767           |

Run counts are asymmetric and favour the comparator: it draws on 30 H¹ runs against this study's 20 per mode, so it has more chances to find a good one.
...
| --------- | ------------------- | ----------- | ---------------- |
| 3         | 0.0970              | 0.0973      | 0.0971           |
| 5         | 0.0975              | 0.0970      | 0.0976           |
| 4         | 0.0977              | 0.0972      | 0.0977           |
| 2         | 0.0982              | 0.0976      | 0.0981           |
| 2.01      | 0.0985              | 0.0979      | 0.0767           |
