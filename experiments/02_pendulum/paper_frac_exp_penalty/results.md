...
- **batch**: 30/40 runs terminated before `T_out = 10`; median 6 iterations, max 10.
- **sequential**: 36/40 runs terminated before `T_out = 150`; median 25.5 iterations, max 150.
...
Run counts are symmetric: the comparator and this study each draw on 20 H¹ runs per mode.
