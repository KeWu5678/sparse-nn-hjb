...
the terminal criterion only from $B$. The ReLU--$\ell^1$ baseline also reaches
the upright only from $B$; its rollout costs are $265.4$ and $24.3$ from $A$
and $B$, respectively.
