...
that the selected ReLU network with $\ell^1$ penalty does not stabilize, while softplus,
...
with $(\alpha,\gamma,p)=(10^{-4},10,2.01)$; the ReLU--$\ell^1$ baseline uses
Algorithm~\ref{alg:q} with $\alpha=10^{-5}$ in panel (a) and $10^{-6}$ in
panel (b), and the homogeneous models use $\alpha=10^{-6}$.
...
Activation & $L^2$ trained & $H^1$ trained \\
\midrule
softplus & $4.97 \times 10^{-1}$ & $2.41 \times 10^{-1}$ \\
tanh & $5.09 \times 10^{-1}$ & $2.37 \times 10^{-1}$ \\
Gaussian & $4.57 \times 10^{-1}$ & $2.36 \times 10^{-1}$ \\
\bottomrule
\end{tabular}
...
\caption{softplus\\ ($N=16$, $\mathrm{Err}_{H^1} = 0.241$).}
...
\caption{$\tanh$\\ ($N=38$, $\mathrm{Err}_{H^1} = 0.237$).}
...
\caption{Gaussian\\ ($N=34$, $\mathrm{Err}_{H^1} = 0.236$).}
...
\midrule
softplus & 16 & $2.41 \times 10^{-1}$ \\
tanh & 38 & $2.37 \times 10^{-1}$ \\
Gaussian & 34 & $2.36 \times 10^{-1}$ \\
\bottomrule
\end{tabular}
\caption{$H^1$ trained}
...
\caption{$k=2$\\ ($N=45$, $\mathrm{Err}_{H^1} = 0.236$).}
...
\caption{$k=3$\\ ($N=28$, $\mathrm{Err}_{H^1} = 0.235$).}
...
\midrule
$k = 2$ & 13 & $2.78 \times 10^{-2}$ & $3.47 \times 10^{-1}$ \\
$k = 3$ & 13 & $2.61 \times 10^{-2}$ & $3.55 \times 10^{-1}$ \\
\bottomrule
\end{tabular}
\caption{$L^2$ trained}
...
Power & $N$ & $\mathrm{Err}_{L^2}$ & $\mathrm{Err}_{H^1}$ \\
\midrule
$k = 2$ & 45 & $4.17 \times 10^{-1}$ & $2.36 \times 10^{-1}$ \\
$k = 3$ & 28 & $4.15 \times 10^{-1}$ & $2.35 \times 10^{-1}$ \\
\bottomrule
\end{tabular}
\caption{$H^1$ trained}
